				...
				<h1 className="text-primary">About Us</h1>				
					<div className="row  d-flex justify-content-center p-5">
						<div className="col-md-6 mt-5">
							<h3>Nandan park was inaugurated on 3rd October – 2003. Nandan Park is now country’s largest and only family entertainment center, which is at tracting largest crowd every day.
                            ...
                            The park is spread over 100 Bighas of land and there are plenty of greenery to spend the time in an Eco-friendly and refreshing ambiance.</h3>
						</div>
						<div className="col-md-6">
							<div className="contact-im">
								<img
									className="w-100"
									src="https://i.ytimg.com/vi/TJtC2aHkknA/maxresdefault.jpg"
									alt=""
								/>
							</div>
						</div>
